...
def translate_opts(parser):
    ...
    parser.add_argument('-data_path', default='../data/preprocessed/',
                        help='Path to data')
    parser.add_argument('-split', default="test",
                        help="Name the evaluation annotated data file")
    ...
    parser.add_argument('-beam_search', action='store_true',
                        help="Use beam search when testing based on the Execution Guided Decoding paper.")
    parser.add_argument('-beam_size', type=int, default=5,
                        help='Beam size for beam search in testing.')
