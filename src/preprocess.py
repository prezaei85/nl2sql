...
# python wikisql/preprocess.py -train_anno data_model/wikisql/annotated_ent/train.jsonl -valid_anno data_model/wikisql/annotated_ent/dev.jsonl -test_anno data_model/wikisql/annotated_ent/test.jsonl

# **Preprocess Options**
parser.add_argument('-config', help="Read options from this file")

parser.add_argument('-train_anno', default="../data/annotated/train.jsonl",
                    help="Path to the training annotated data")
parser.add_argument('-valid_anno', default="../data/annotated/dev.jsonl",
                    help="Path to the validation annotated data")
parser.add_argument('-test_anno', default="../data/annotated/test.jsonl",
